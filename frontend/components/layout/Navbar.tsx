...
export function Navbar() {
  ...
  return <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0a0d3a]/85 backdrop-blur-xl">
    <div className="page-shell flex h-[76px] items-center justify-between gap-5">
      <Link href="/" className="group flex items-center gap-3 shrink-0"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#5865f2] text-white transition-transform group-hover:rotate-6"><img src="/music-logo.svg" alt="" className="h-5 w-5" /></span><span className="display text-xl tracking-[-.08em]">SOUNDVAULT</span></Link>
